...
contract DeploymentScript is Script {
    ...
    address constant LPROUTER = address(0x2b925D1036E2E17F79CF9bB44ef91B95a3f9a084);
    address constant SWAPROUTER = address(0xB8b53649b87F0e1eb3923305490a5cB288083f82);

    IPoolManager manager = IPoolManager(POOLMANAGER);
    PoolModifyLiquidityTest lpRouter = PoolModifyLiquidityTest(LPROUTER);
    ...
    function run() external {
        ...
        address SUSDC_ADDRESS = address(new SemioticsUSDC());
        address SETH_ADDRESS = address(new SemioticsETH());
        ...
        lpRouter.modifyLiquidity(pool, IPoolManager.ModifyLiquidityParams(-887220, 887220, 100000000000000000000000, 0), hookData);
    }
}